...
export function buildLoginCommand(cfg: LoginCommandConfig): BotCommand {
    const noticeContent = [
        ...
        '',
        `${process.env.BOT_NAME} is **[open source](<https://github.com/rekkih/chuniwidget>)** and can be freely inspected to confirm this. **You should ONLY give your SEGA ID to open source bots.** Closed-source bots are known to steal accounts.`,
        '',
